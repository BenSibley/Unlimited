...
if ( ! function_exists( 'unlimited_social_array' ) ) {
	function unlimited_social_array() {
		...
		$social_sites = array(
			...
			'researchgate'  => 'unlimited_researchgate_profile',
			...
			'strava'        => 'unlimited_strava_profile',
...
//----------------------------------------------------------------------------------
function ct_unlimited_output_last_updated_date() {
	
	global $post;

	if ( get_the_modified_date() != get_the_date() ) {
		$updated_post = get_post_meta( $post->ID, 'ct_unlimited_last_updated', true );
