...
function unlimited_load_scripts_styles() {
	...
	wp_enqueue_style( 'ct-unlimited-font-awesome', get_template_directory_uri() . '/assets/font-awesome/css/all.min.css' );
...
function unlimited_enqueue_admin_styles( $hook ) {
	...
	if ( $hook == 'post.php' || $hook == 'post-new.php' ) {
		...
		wp_enqueue_style( 'ct-unlimited-google-fonts', $fonts_url );
	}
}
